...
const PI_EMAIL = 'huangqq@bjfu.edu.cn'
const PI_RESEARCHGATE = 'https://www.researchgate.net/profile/Qingqing-Huang-6'
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-serif font-bold text-forest-800 dark:text-forest-100">
                  {isZh ? '黄青青' : 'Qingqing Huang'}
                </h2>
                <p className="text-forest-600 dark:text-forest-300 font-medium mt-1">{t.team.pi.title}</p>
                <p className="text-gray-600 dark:text-gray-300 mt-4 leading-relaxed">{t.team.pi.bio}</p>
                <div className="flex flex-wrap gap-3 mt-5">
                  <a href={PI_RESEARCHGATE} target="_blank" rel="noopener noreferrer"
        ...
        {members.length > 0 && (
          <section className="mb-16">
            <h2 className="text-xl font-serif font-bold text-forest-800 dark:text-forest-100 mb-6">{t.team.members}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
              {members.map(m => (
                <div key={m.id} className="bg-white dark:bg-forest-800 rounded-xl p-5 border border-forest-100 dark:border-forest-700 shadow-sm">
        ...
        <section className="bg-gradient-to-br from-forest-700 to-forest-900 rounded-2xl p-8 text-white text-center max-w-2xl mx-auto">
          ...
          <a href={`mailto:${PI_EMAIL}`}
            ...
            <Mail size={16} /> {t.team.joinUs.btn}
          </a>
        </section>
      </div>
    </div>
